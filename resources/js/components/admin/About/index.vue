<script setup>
    ...
    const updateAbout= async ()=> {
        let response = await axios.post(`/api/update_about/${form.value.id}`,form.value)
        if(response) {
            toast.fire({
                icon:"success",
                    ...
                    <div class="card_wrapper">
                        <div class="wrapper_left">
                            <div class="card">
                                ...
                                <p>Address</p>
                                <input type="text" name="address" class="input" v-model="form.address"/>
                        ...
                        <div class="wrapper_right ">
                            ...
                            <div class="card">
                                <p>CV</p>
                                <input type="file" name="cv" id="filecv" @change="uploadCv"/>
                            </div>
                        </div>
